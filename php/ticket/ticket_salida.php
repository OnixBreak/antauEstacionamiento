<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode("Folio: ".$folio),0,'C',false);

    $pdf->MultiCell(0,6,utf8_decode("Fecha: ".$fecha_ticket),0,'C',false);
    $pdf->MultiCell(0,6,utf8_decode("Entrada: ".$hora_ticket),0,'C',false);
    $pdf->MultiCell(0,6,utf8_decode("Salida: ".$hora_salida),0,"C",false);
    $pdf->MultiCell(0,6,utf8_decode("Placas: ".$placa_ticket),0,'C',false);
    $pdf->MultiCell(0,6,utf8_decode("Atiende : ".$atendio),0,'C',false);
    $pdf->SetFont('Arial','B',18);
    $pdf->MultiCell(0,8,utf8_decode("Total $ ".$total_a_pagar.".00"),0,'C',false);
